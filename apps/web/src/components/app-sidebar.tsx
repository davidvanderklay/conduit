...
export function AppSidebar({
  ...
  return (
    <aside className="fixed bottom-0 left-0 right-0 z-30 border-t border-zinc-800 bg-zinc-950/95 backdrop-blur-xl md:bottom-auto md:right-auto md:top-16 md:h-[calc(100vh-4rem)] md:w-16 md:border-r md:border-t-0">
      <nav
